...
namespace PayeeProcessor.DAL.Repository
{
    public interface IRepository<TEntity> where TEntity : class
    {
        ...
        IQueryable<TEntity> Fetch(Expression<Func<TEntity, bool>> predicate, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null, int? page = default(int?), int? pageSize = default(int?));
