...
{
    public class MoveStateCommandRationToComputeTable
    {
        ...
        public void MoveStateCommandRationToComputeTableProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssStateCommandRatioCompute.MoveStateCommandRatioToComputeTable(batchId);
