...
{
    public class UpdateStateCommandRatioAmountForFlagValue
    {
        ...
        public void UpdateStateCommandFlagRatioAmountProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssStateCommandRatioCompute.UpdateStateCommandFlagValueWithRatioAmountFromRatioAmountOfNonFlagRecords(batchId);
