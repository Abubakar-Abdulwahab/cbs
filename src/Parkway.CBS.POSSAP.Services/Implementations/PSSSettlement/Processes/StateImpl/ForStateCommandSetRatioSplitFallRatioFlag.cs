...
{
    public class ForStateCommandSetRatioSplitFallRatioFlag
    {
        private static readonly ILogger log = new Log4netLogger();

        public IUoW UoW { get; set; }

        public IPSSSettlementRequestTransactionConfigStateCommandRatioDAOManager _pssStateCommandRatio { get; set; }
        ...
        private void SetStateCommandRatioDAOManager()
        {
            if (_pssStateCommandRatio == null) { _pssStateCommandRatio = new PSSSettlementRequestTransactionConfigStateCommandRatioDAOManager(UoW); }
        }
        ...
        public void SetFallFlagProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                SetStateCommandRatioDAOManager();
                UoW.BeginTransaction();
                _pssStateCommandRatio.SetFallFlagForStateCommand(batchId);
