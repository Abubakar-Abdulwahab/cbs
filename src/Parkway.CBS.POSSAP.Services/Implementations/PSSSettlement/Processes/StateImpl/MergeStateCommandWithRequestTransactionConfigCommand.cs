...
{
    public class MergeStateCommandWithRequestTransactionConfigCommand
    {
        private static readonly ILogger log = new Log4netLogger();

        public IUoW UoW { get; set; }

        public IPSSSettlementRequestTransactionConfigCommandStateCommandDAOManager _pssRequestTransactionCommandStateCommand { get; set; }
        ...
        {
            if (_pssRequestTransactionCommandStateCommand == null) { _pssRequestTransactionCommandStateCommand = new PSSSettlementRequestTransactionConfigCommandStateCommandDAOManager(UoW); }
        }
        ...
        public void DoMergeWithStateCommandProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssRequestTransactionCommandStateCommand.MergeCommandTransactionRequestWithStateCommand(batchId);
            ...
            finally
            {
                ...
                _pssRequestTransactionCommandStateCommand = null;
                _processCompo = null;
            }
        }
