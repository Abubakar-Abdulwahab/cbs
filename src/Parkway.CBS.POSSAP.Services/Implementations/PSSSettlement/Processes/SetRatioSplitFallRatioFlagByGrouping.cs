...
{
    public class SetRatioSplitFallRatioFlagByGrouping
    {
        private static readonly ILogger log = new Log4netLogger();

        public IUoW UoW { get; set; }

        public IPSSSettlementRequestTransactionConfigCommandRatioDAOManager _pssCommandTransactionRequestRatio { get; set; }
        ...
        private void SetCommandRatioTransactionRequestDAOManager()
        {
            if (_pssCommandTransactionRequestRatio == null) { _pssCommandTransactionRequestRatio = new PSSSettlementRequestTransactionConfigCommandRatioDAOManager(UoW); }
        }
        ...
        public void DoGroupingByConfigAndBatchProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                SetCommandRatioTransactionRequestDAOManager();
                UoW.BeginTransaction();
                _pssCommandTransactionRequestRatio.SetFallRatioFlag(batchId);
            ...
            finally
            {
                ...
                _pssCommandTransactionRequestRatio = null;
                _processCompo = null;
            }
        }
