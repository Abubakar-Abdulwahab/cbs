...
{
    public class AddCommandRatioSumToCommandFeePartyCompute
    {
        ...
        public void UpdateRatioCommandCount(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssCommandRatioCompute.SumCommandRatio(batchId);
