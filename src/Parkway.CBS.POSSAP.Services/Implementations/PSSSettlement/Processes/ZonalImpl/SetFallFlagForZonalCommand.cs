...
{
    public class SetFallFlagForZonalCommand
    {
        private static readonly ILogger log = new Log4netLogger();

        public IUoW UoW { get; set; }

        public IPSSSettlementRequestTransactionConfigCommandZonalCommandRatioDAOManager _pssRequestZonalCommandSplitRatio { get; set; }
        ...
        {
            if (_pssRequestZonalCommandSplitRatio == null) { _pssRequestZonalCommandSplitRatio = new PSSSettlementRequestTransactionConfigCommandZonalCommandRatioDAOManager(UoW); }
        }
        ...
        public void SetZonalCommandWithFallFlag(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssRequestZonalCommandSplitRatio.SetZonalCommandWithFallFlag(batchId);
            ...
            finally
            {
                ...
                _pssRequestZonalCommandSplitRatio = null;
                _processCompo = null;
            }
        }
