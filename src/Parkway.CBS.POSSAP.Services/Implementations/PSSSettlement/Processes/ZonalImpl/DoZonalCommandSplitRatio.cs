...
{
    public class DoZonalCommandSplitRatio
    {
        ...
        public void DoSplitRationForZonalCommand(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssRequestZonalCommandSplitRatio.DoSplitRatioForZonalCommand(batchId);
