...
{
    public class MoveRecordsForZonalCommandToComputeTable
    {
        ...
        public void MoveToComputeTable(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssRequestZonalCommandRatioCompute.MoveZonalRatioToComputeTable(batchId);
