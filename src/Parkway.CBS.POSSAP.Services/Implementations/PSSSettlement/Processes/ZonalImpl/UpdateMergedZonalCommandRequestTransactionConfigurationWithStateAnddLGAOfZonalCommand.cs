...
{
    public class UpdateMergedZonalCommandRequestTransactionConfigurationWithStateAnddLGAOfZonalCommand
    {
        private static readonly ILogger log = new Log4netLogger();

        public IUoW UoW { get; set; }

        public IPSSSettlementRequestTransactionConfigCommandZonalCommandDAOManager _pssRequestTransactionCommandZonalCommand { get; set; }
        ...
        {
            if (_pssRequestTransactionCommandZonalCommand == null) { _pssRequestTransactionCommandZonalCommand = new PSSSettlementRequestTransactionConfigCommandZonalCommandDAOManager(UoW); }
        }
        ...
        public void UpdateZonalStateAndLGAProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssRequestTransactionCommandZonalCommand.UpdateBatchWithStateAndLGAOfZonalCommand(batchId);
            ...
            finally
            {
                ...
                _pssRequestTransactionCommandZonalCommand = null;
                _processCompo = null;
            }
        }
