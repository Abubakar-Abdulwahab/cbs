...
{
    public class MergeZonalCommandWithRequestTransactionConfigCommand
    {
        ...
        public void DoMergeWithZonalCommandProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssRequestTransactionCommandZonalCommand.MergeCommandTransactionRequestWithZonalCommand(batchId);
