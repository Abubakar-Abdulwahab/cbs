...
{
    public class UpdateZonalCommandRatioAmountBasedOffFeePercentageForNonFlagRecords
    {
        ...
        public void AddRatioAmountSumComputeTableProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssRequestZonalCommandRatioCompute.UpdateTheRatioAmountForNonFlagRecordsBasedOffFeePercentage(batchId);
