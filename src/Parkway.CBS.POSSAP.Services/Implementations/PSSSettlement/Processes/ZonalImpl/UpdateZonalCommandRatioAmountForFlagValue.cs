...
{
    public class UpdateZonalCommandRatioAmountForFlagValue
    {
        ...
        public void UpdateZonalCommandFlagRatioAmountProcessing(string tenantName, long batchId)
        {
            ...
            try
            {
                ...
                _pssRequestZonalCommandRatioCompute.UpdateTheRatioAmountForFlagRecordsBasedOffRatioAmountSum(batchId);
