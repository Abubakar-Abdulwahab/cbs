...
{
    public class DeploymentAllowancePaymentRequest : CBSBaseModel
    {
        ...
        public virtual PSSRequestInvoice PSSRequestInvoice { get; set; }
        ...
        public virtual IEnumerable<DeploymentAllowancePaymentRequestItem> DeploymentAllowancePaymentRequestItems { get; set; }
