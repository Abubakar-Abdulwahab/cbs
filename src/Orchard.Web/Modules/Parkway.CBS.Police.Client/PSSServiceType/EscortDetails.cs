...
{
    public class EscortDetails : IPSSServiceTypeDetails
    {
        ...
        public EscortDetails(IOrchardServices orchardServices, Lazy<IPSSEscortDetailsManager<PSSEscortDetails>> escortDetailsManager, Lazy<IRequestStatusLogManager<RequestStatusLog>> requestStatusLogManager, ICoreEscortService coreEscortService)
        {
