...
{
    public class CreateMDAModelBinder : IModelBinder
    {
        public ILogger Logger { get; set; }

        public CreateMDAModelBinder()
        {
        ...
        public bool BindModel(HttpActionContext actionContext, ModelBindingContext bindingContext)
        {
            try
            {
                CreateMDAModel createMDAObject = null;
                ...
                createMDAObject = JsonConvert.DeserializeObject<CreateMDAModel>(modelJSONString);
