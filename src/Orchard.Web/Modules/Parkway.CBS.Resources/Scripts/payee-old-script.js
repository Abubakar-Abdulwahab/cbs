$(document).ready(function () {
    ...
    function insertRow() {
        ...
        //DirectAssessmentPayeeLines[0].TIN
        var td2 = $('<td>' + $("#TIN").val() + '</td>').appendTo(tr);
        var tdInput2 = $('<input hidden name="DirectAssessmentPayeeLines[' + rowNumber + '].TIN" value="' + $("#TIN").val() + '"/>').appendTo(td2);
       ...
       var td6 = $('<td>' + $("#LGA :selected").val() + " " + $("#Email").val() + '</td>').appendTo(tr);
