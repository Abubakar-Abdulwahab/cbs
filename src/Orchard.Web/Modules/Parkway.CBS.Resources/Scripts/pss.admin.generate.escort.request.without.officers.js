$(document).ready(function () {
    ...
    $(".billing-type-radio").change(function (e) {
        if (e.currentTarget.id === "weeklyRadioBtn") {
            $("#numberOfDaysFieldContainer").show();
            $("#numberOfDaysFieldContainer input").prop("required", true);
        } else {
            $("#numberOfDaysFieldContainer input").prop("required", false);
            $("#numberOfDaysFieldContainer").hide();
        }
    });
