...
{
    public class CharacterCertificate : IPSSServiceTypeUSSDVerificationImpl
    {
        ...
        public CharacterCertificate(Lazy<IPSSRequestManager<PSSRequest>> requestManager, Lazy<ITypeImplComposer> typeImplComposer)
        {
