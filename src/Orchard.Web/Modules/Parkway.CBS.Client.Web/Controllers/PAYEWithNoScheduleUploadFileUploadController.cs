...
{
    public class PAYEWithNoScheduleUploadFileUploadController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult NoScheduleFileUpload()
        {
            TempData = null;
            string errorMessage = null;
            try
            {
                Logger.Information("Processing for NoScheduleFileUpload assessment post");
                ...
                {
                    Logger.Error(string.Format("Stage mismatch in NoScheduleFileUpload. Stage is sess: " + processStage.InvoiceGenerationStage));
                ...
                return RedirectToRouteX(RouteName.PAYENoScheduleUpload.NoScheduleUploadShowScheduleResult);
            }
