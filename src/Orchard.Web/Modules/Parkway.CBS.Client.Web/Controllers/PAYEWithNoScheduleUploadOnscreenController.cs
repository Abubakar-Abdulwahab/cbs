...
namespace Parkway.CBS.Client.Web.Controllers
{
    public class PAYEWithNoScheduleUploadOnscreenController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult NoScheduleOnscreen(ICollection<PAYEAssessmentLine> DirectAssessmentPayeeLines)
        {
            TempData = null;
