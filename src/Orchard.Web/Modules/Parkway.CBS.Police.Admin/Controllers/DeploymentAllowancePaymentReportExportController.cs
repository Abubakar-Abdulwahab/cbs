...
{
    public class DeploymentAllowancePaymentReportExportController : Controller
    {
        ...
        public DeploymentAllowancePaymentReportExportController(IOrchardServices orchardServices, IDeploymentAllowancePaymentReportHandler handler, INotifier notifier)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult> Download(DeploymentAllowancePaymentReportVM userInputModel, PagerParameters pagerParameters, ExportFormat? format)
        {
            try
            {
                ...
                var viewModel = _handler.GetDeploymentAllowancePaymentReportVM(searchParams);

                switch (format)
                {
                    case ExportFormat.Excel:
                        string fileName = "Deployment_Allowance_Payment_Report.xlsx";
                        await DoExcelAsync(viewModel.DeploymentAllowancePaymentReportItems, fileName, nameof(PSSRequestSettingsName.PSSDeploymentAllowancePaymentReport));
                        break;
                    case ExportFormat.PDF:
                        string PDFfileName = "Deployment_Allowance_Payment_Report.pdf";
                        ...
                        var template = TemplateUtil.RazorTemplateFor(nameof(PSSRequestSettingsName.PSSDeploymentAllowancePaymentReport));
