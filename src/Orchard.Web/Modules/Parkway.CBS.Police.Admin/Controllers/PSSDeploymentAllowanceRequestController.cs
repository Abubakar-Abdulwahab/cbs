...
{
    [Admin]
    public class PSSDeploymentAllowanceRequestController : Controller
    {
        ...
        public PSSDeploymentAllowanceRequestController(IOrchardServices orchardServices, IPSSDeploymentAllowanceHandler deploymentAllowanceHandler, IShapeFactory shapeFactory)
        {
        ...
        // GET: PSSDeploymentAllowanceRequestController
        public ActionResult DeploymentAllowanceRequest(DeploymentAllowanceReportVM userInput, PagerParameters pagerParameters)
        {
            try
            {
                ...
                OfficerDeploymentAllowanceSearchParams searchParams = new OfficerDeploymentAllowanceSearchParams
                {
                    ...
                    RequestStatus = DeploymentAllowanceStatus.PendingApproval,
        ...
        /// <summary>
        /// Approve deployment allowance request
        /// </summary>
        /// <param name="requestDetailsVM"></param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult ApproveRequest(EscortDeploymentRequestDetailsVM requestDetailsVM)
        {
            try
            {
                _deploymentAllowanceHandler.CheckForPermission(Permissions.CanApproveDeploymentAllowance);

                requestDetailsVM.ApprovalStatus = (int)PSSRequestStatus.Approved;
                requestDetailsVM.ApproverId = _orchardServices.WorkContext.CurrentUser.Id;
                var details = _deploymentAllowanceHandler.SaveRequestApprovalDetails(requestDetailsVM.DeploymentAllowanceRequestId, requestDetailsVM);
                ...
                return RedirectToRoute("pss.admin.police.deploymentallowance.request");
            }
            catch (UserNotAuthorizedForThisActionException)
            {
                _notifier.Add(NotifyType.Warning, PoliceErrorLang.usernotauthorized());
        ...
        /// <summary>
        /// Reject deployment allowance request
        /// </summary>
        /// <param name="requestDetailsVM"></param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult RejectRequest(EscortDeploymentRequestDetailsVM requestDetailsVM)
        {
            try
            {
                _deploymentAllowanceHandler.CheckForPermission(Permissions.CanApproveDeploymentAllowance);
                requestDetailsVM.ApprovalStatus = (int)PSSRequestStatus.Rejected;
                requestDetailsVM.ApproverId = _orchardServices.WorkContext.CurrentUser.Id;
                var details = _deploymentAllowanceHandler.SaveRequestApprovalDetails(requestDetailsVM.DeploymentAllowanceRequestId, requestDetailsVM);
