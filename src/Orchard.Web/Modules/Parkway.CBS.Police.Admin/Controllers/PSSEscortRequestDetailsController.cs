...
{
    public class PSSEscortRequestDetailsController : Controller
    {
        private readonly IOrchardServices _orchardServices;
        private readonly IPSSEscortRequestDetailsHandler _handler;
        private readonly INotifier _notifier;
        ILogger Logger { get; set; }

        public PSSEscortRequestDetailsController(IOrchardServices orchardServices, IPSSEscortRequestDetailsHandler handler)
        {
        ...
        public ActionResult ViewDispatchNote(string fileRefNumber)
        {
            try
            {
                CreateCertificateDocumentVM result = _handler.CreateDispatchNoteByteFile(fileRefNumber);
