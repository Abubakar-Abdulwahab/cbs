...
namespace Parkway.CBS.Services.Logger
{
    public class ServicesLog4netLogger : ILogger
    {
        private static readonly ILog log = LogManager.GetLogger("Parkway.CBS.Services.Logger");
